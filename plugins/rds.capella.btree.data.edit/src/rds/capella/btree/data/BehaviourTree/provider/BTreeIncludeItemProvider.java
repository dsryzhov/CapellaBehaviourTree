 ...
 * @generated
 */
public class BTreeIncludeItemProvider extends BTreeNodeItemProvider {
	/**
	...
	protected void addBtreeReferencePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				BehaviourTreePackage.Literals.BTREE_INCLUDE__BTREE_REFERENCE, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_BTreeInclude_type") : //$NON-NLS-1$
				getString("_UI_BTreeInclude_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
