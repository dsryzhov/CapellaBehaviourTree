...
/**
 * This is the item provider adapter for a {@link rds.capella.btree.data.BehaviourTree.Inverter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InverterItemProvider extends BTreeDecoratorItemProvider implements IEditingDomainItemProvider,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Inverter")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		// begin-extension-code
		return label == null || label.length() == 0 ? "[" + getString("_UI_Inverter_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		// end-extension-code
	}
