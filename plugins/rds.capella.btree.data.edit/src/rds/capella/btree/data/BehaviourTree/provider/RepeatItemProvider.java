...
/**
 * This is the item provider adapter for a {@link rds.capella.btree.data.BehaviourTree.Repeat} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepeatItemProvider extends BTreeDecoratorItemProvider implements IEditingDomainItemProvider,
	...
	public String getText(Object object) {
		...
		// begin-extension-code
		return label == null || label.length() == 0 ? "[" + getString("_UI_Repeat_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		// end-extension-code
	}
