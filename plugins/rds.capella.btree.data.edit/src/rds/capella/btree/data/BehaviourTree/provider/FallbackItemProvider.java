...
/**
 * This is the item provider adapter for a {@link rds.capella.btree.data.BehaviourTree.Fallback} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FallbackItemProvider extends BTreeFallbackItemProvider implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public FallbackItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Fallback")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		// begin-extension-code
		return label == null || label.length() == 0 ? "[" + getString("_UI_Fallback_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		// end-extension-code
	}
